...
from utils.importance_score import compute_accumulated_gradients, \
    compute_filters_importance_score_feature_extraction_filters, \
    permute_filters_ds_cnn, permute_batch_norm_ds_cnn_layers, assign_pretrained_ds_convolution_filters, \
    compute_descending_filters_score_indexes_ds_cnn, compute_accumulated_gradients_pointwise_layers, \
    compute_pointwise_importance_score_ds_cnn
...
if __name__ == '__main__':
    ...
    parser.add_argument('--solver_time_limit', default=10800, type=int)
    ...
    setup_logging(args=args,
                  experiment_name="KWS_ARM_{}_{}_DS_CNN".format("Bottom_up" if args.bottom_up else "Top_down",
